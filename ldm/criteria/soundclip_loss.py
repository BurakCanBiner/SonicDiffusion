...
class SoundCLIPLoss(torch.nn.Module):
    ...
    def __init__(self, opts):
        ...
        base_path = "/kuacc/users/bbiner21/Github/sound-guided-semantic-image-manipulation"
        self.audio_encoder = AudioEncoder()
        
        self.audio_encoder.load_state_dict(copyStateDict(torch.load(base_path + "/pretrained_models/resnet18.pth")))
